...
export default function Footer() {
  ...
  return (
    <footer className="bg-quaternary text-white text-base py-6 w-full">
      <div className="container mx-auto flex flex-col items-center gap-4 sm:flex-row sm:justify-between sm:gap-0 px-4">
        {/* Derechos de autor */}
        <p className="text-center sm:text-left text-xs sm:text-base w-full sm:w-auto mb-2 sm:mb-0">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6 w-full sm:w-auto">
          ...
          <a
            ...
            className="flex items-center gap-2 hover:text-gray-400 text-base sm:text-lg px-2 py-1 rounded transition-colors"
          >
            <FiGithub />
            <span>GitHub</span>
          </a>
          ...
          <div className="flex items-center gap-2 bg-white/10 rounded px-2 py-1">
            <FiMail />
            <span className="text-xs sm:text-base break-all">
            ...
            {copied && (
              <span className="text-green-400 text-xs ml-1">¡Copiado!</span>
            )}
          </div>
        </div>
      </div>
