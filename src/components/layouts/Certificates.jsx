...
export default function Certificates() {
    ...
    return (
        <div className="w-full flex flex-col">
            <h2 className="text-heading-1 text-gray-800 mb-6 text-left pl-4">Certificados</h2>
            {totalPages > 1 && (
                <div className="flex justify-center mt-2 mb-8 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
                    <div className="flex gap-1 sm:gap-2 px-1 min-w-max flex-wrap justify-center scroll-smooth snap-x">
                        ...
                        <button
                            ...
                            disabled={page === 1}
                            className="px-2 sm:px-3 py-1 sm:py-2 rounded bg-secondary text-white disabled:opacity-50 text-caption sm:text-body-small min-w-[36px] sm:min-w-[40px] snap-start"
                        >
                        ...
                        <button
                            ...
                            className="px-2 sm:px-3 py-1 sm:py-2 rounded bg-secondary text-white disabled:opacity-50 text-caption sm:text-body-small min-w-[36px] sm:min-w-[40px] snap-end"
                        >
                            <span className="inline sm:hidden">→</span>
